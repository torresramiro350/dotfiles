return {
  ...
  keys = {
    ...
    { "<S-Enter>",   function() require("noice").redirective(vim.fn.getcmdline()) end,              desc = "Redirect cmdline",                 mode = "c" },
    { "<c-f>",       function() if not require("noice.lsp").scroll(4) then return "<c-f>" end end,  desc = "Scroll forward",                   silent = true, expr = true, mode = { "n", "i", "s" } },
